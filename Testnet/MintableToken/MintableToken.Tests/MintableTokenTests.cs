...
namespace Stratis.SmartContracts.Samples.Tests
{
    public class MintableTokenTests
    {
        ...
        public void GetBalance_Returns_Correct_Balance()
        {
            ...
            Assert.Equal(balance, mintableToken.GetBalance(this.spender));
        }
        ...
        public void Approve_Sets_Approval_Correctly_When_NonZero()
        {
            ...
            mintableToken.Approve(this.spender, approval, newApproval);
        ...
        public void Approve_Does_Not_Set_Approval_If_Different()
        {
            ...
            Assert.False(mintableToken.Approve(this.spender, differentApproval, newApproval));
        ...
        public void TransferTo_Greater_Than_Balance_Returns_False()
        {
            ...
            Assert.False(mintableToken.TransferTo(this.destination, amount));
        ...
        public void TransferTo_Destination_With_Balance_Greater_Than_uint_MaxValue_Returns_False()
        {
            ...
            Assert.ThrowsAny<OverflowException>(() => mintableToken.TransferTo(this.destination, amount));
        ...
        public void TransferFrom_Greater_Than_Senders_Allowance_Returns_False()
        {
            ...
            Assert.False(mintableToken.TransferFrom(this.owner, this.destination, amount));
        ...
        public void TransferFrom_To_Destination_With_Balance_Greater_Than_Amount_MaxValue_Returns_False()
        {
            ...
            Assert.ThrowsAny<OverflowException>(() => mintableToken.TransferFrom(this.owner, this.destination, amount));
        ...
        public void TransferTo_Self()
        {
            ...
            Assert.True(mintableToken.TransferTo(subject, amount));
        ...
        public void TransferFrom_Self()
        {
            ...
            // Transfer all of the subject's tokens
            Assert.True(mintableToken.TransferFrom(subject, subject, amount));
        ...
        public void Constructor_Sets_Name_And_Symbol_And_Decimals()
        {
            ...
            this.mockPersistentState.Verify(s => s.SetString(nameof(mintableToken.Symbol), this.symbol));
            this.mockPersistentState.Verify(s => s.SetBytes(nameof(mintableToken.Decimals), new[] { this.decimals }));

            // Verify name property returns name.
            this.mockPersistentState.Setup(s => s.GetString(nameof(mintableToken.Name))).Returns(this.name);
            Assert.Equal(this.name, mintableToken.Name);

            // Verify symbol property returns symbol.
            this.mockPersistentState.Setup(s => s.GetString(nameof(mintableToken.Symbol))).Returns(this.symbol);
            Assert.Equal(this.symbol, mintableToken.Symbol);

            // Verify decimals property returns decimals.
            this.mockPersistentState.Setup(s => s.GetBytes(nameof(mintableToken.Decimals))).Returns(new[] { this.decimals });
            Assert.Equal(this.decimals, mintableToken.Decimals);
        }
    }
}