...
/// </summary>
public class NonFungibleToken : SmartContract, ISupportsInterface, INonFungibleToken, INonFungibleTokenMetadata
{
    /// <summary>
    ...
    protected void SetSupportedInterfaces(TokenInterface interfaceId, bool value) => State.SetBool($"SupportedInterface:{(uint)interfaceId}", value);
    ...
    protected void EnsureOwnerOnly()
    {
