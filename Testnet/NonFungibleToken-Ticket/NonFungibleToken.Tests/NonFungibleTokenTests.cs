...
public class NonFungibleTokenTests
{
    ...
    public void Constructor_Sets_Values()
    {
        ...
        Assert.True(state.GetBool("SupportedInterface:100"));
    ...
    [Fact]
    public void IsUsed_ReturnsFalseForNonExistingToken()
    {
        ...
        Assert.False(nonFungibleToken.IsUsed(1));
    }

    [Fact]
    public void IsUsed_ReturnsFalseForNonMarkedToken()
    {
    ...
    [Fact]
    public void MarkAsUsed_ChangesState()
    {
        var ownerAddress = "0x0000000000000000000000000000000000000006".HexToAddress();
        state.SetAddress("IdToOwner:1", ownerAddress);
        state.SetUInt256($"Balance:{ownerAddress}", 1);
        ...
        nonFungibleToken.MarkAsUsed(1);

        Assert.True(nonFungibleToken.IsUsed(1));
    }

    [Fact]
    public void MarkAsUsed_IsSafeToRunMultipleTimes()
    {
        var ownerAddress = "0x0000000000000000000000000000000000000006".HexToAddress();
        state.SetAddress("IdToOwner:1", ownerAddress);
        state.SetUInt256($"Balance:{ownerAddress}", 1);
    ...
    [Fact]
    public void TransferFrom_Success_ForNotUsedTicket()
    {
        var ownerAddress = "0x0000000000000000000000000000000000000006".HexToAddress();
    ...
    [Fact]
    public void TransferFrom_TicketStaysUnusedAfterTransfer()
    {
        var ownerAddress = "0x0000000000000000000000000000000000000006".HexToAddress();
        var targetAddress = "0x0000000000000000000000000000000000000007".HexToAddress();
        state.SetAddress("IdToOwner:1", ownerAddress);
    ...
    [Fact]
    public void TransferFrom_ForUsedTicket_ThrowsException()
    {
        var ownerAddress = "0x0000000000000000000000000000000000000006".HexToAddress();
        var targetAddress = "0x0000000000000000000000000000000000000007".HexToAddress();
        state.SetAddress("IdToOwner:1", ownerAddress);
        ...
        nonFungibleToken.Invoking(c => c.TransferFrom(ownerAddress, targetAddress, 1))
            .Should()
            .ThrowExactly<SmartContractAssertException>()
            .WithMessage("Ticket was already used.");
    }
