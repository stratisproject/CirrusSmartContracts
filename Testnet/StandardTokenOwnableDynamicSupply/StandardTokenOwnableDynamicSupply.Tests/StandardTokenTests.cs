...
namespace StandardTokenOwnableDynamicSupply.Tests
{
    ...
    public class StandardTokenTests
    {
        ...
        public void Constructor_Sets_TotalSupply()
        {
            ...
            this.mockPersistentState.Verify(s => s.SetUInt256(nameof(StandardTokenOwnableDynamicSupplyContract.TotalSupply), totalSupply));
        }
        ...
        public void GetBalance_Returns_Correct_Balance()
        {
            ...
            var standardToken = new StandardTokenOwnableDynamicSupplyContract(this.mockContractState.Object, 100_000, this.name, this.symbol, this.decimals);
        ...
        public void Approve_Sets_Approval_Correctly()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.ApprovalLog { Owner = this.owner, Spender = this.spender, Amount = approval, OldAmount = 0 }));
        }
        ...
        public void Approve_Sets_Approval_Correctly_When_NonZero()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.ApprovalLog { Owner = this.owner, Spender = this.spender, Amount = newApproval, OldAmount = approval }));
        }
        ...
        public void TransferTo_0_Returns_True()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.TransferLog { From = this.sender, To = this.destination, Amount = amount }));
        }
        ...
        public void TransferFrom_0_Returns_True()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.TransferLog { From = this.owner, To = this.destination, Amount = amount }));
        }
        ...
        public void TransferTo_Self()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.TransferLog { From = subject, To = subject, Amount = amount }));
        }
