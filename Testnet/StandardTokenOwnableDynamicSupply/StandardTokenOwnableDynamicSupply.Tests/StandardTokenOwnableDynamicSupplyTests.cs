...
namespace StandardTokenOwnableDynamicSupply.Tests
{
    ...
    public class StandardTokenOwnableDynamicSupplyTests
    {
        ...
        public StandardTokenOwnableDynamicSupplyTests()
        {
        ...
        public void RenounceOwnership_Succeeds_For_Owner()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.OwnershipTransferred() { PreviousOwner = this.owner, NewOwner = Address.Zero}));
        }
        ...
        public void TransferOwnership_Succeeds_For_Owner()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.OwnershipTransferred() { PreviousOwner = this.owner, NewOwner = this.destination }));
        }
        ...
        public void Mint_Increases_Balance_And_TotalSupply()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.TransferLog { From = Address.Zero, To = this.sender, Amount = mintAmount }));
        ...
        public void Burn_Decreases_Balance_And_TotalSupply()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.TransferLog { From = this.sender, To = Address.Zero, Amount = burnAmount }));
        ...
        public void BurnWithMetadata_Records_Metadata_In_Log()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new StandardTokenOwnableDynamicSupplyContract.BurnMetadata() { From = this.sender, Amount = burnAmount, Metadata = "Hello world" }));
        }
    }
}
