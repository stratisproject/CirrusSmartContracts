...
namespace InterFluxStandardTokenTests
{
    ...
    public class StandardTokenTests
    {
        ...
        public void Constructor_Sets_TotalSupply()
        {
            ...
            this.mockPersistentState.Verify(s => s.SetUInt256(nameof(InterFluxStandardToken.TotalSupply), totalSupply));
        }
        ...
        public void Approve_Sets_Approval_Correctly()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new InterFluxStandardToken.ApprovalLog { Owner = this.owner, Spender = this.spender, Amount = approval, OldAmount = 0 }));
        }
        ...
        public void Approve_Sets_Approval_Correctly_When_NonZero()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new InterFluxStandardToken.ApprovalLog { Owner = this.owner, Spender = this.spender, Amount = newApproval, OldAmount = approval }));
        }
        ...
        public void TransferTo_0_Returns_True()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new InterFluxStandardToken.TransferLog { From = this.sender, To = this.destination, Amount = amount }));
        }
        ...
        public void TransferFrom_0_Returns_True()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new InterFluxStandardToken.TransferLog { From = this.owner, To = this.destination, Amount = amount }));
        }
        ...
        public void TransferTo_Self()
        {
            ...
            this.mockContractLogger.Verify(l => l.Log(It.IsAny<ISmartContractState>(), new InterFluxStandardToken.TransferLog { From = subject, To = subject, Amount = amount }));
        }
