...
/// </summary>
[Deploy]
public class InterFluxStandardToken : SmartContract, IStandardToken256, IOwnable, IMintable, IBurnable, IBurnableWithMetadata
{
    /// <summary>
    ...
    public InterFluxStandardToken(ISmartContractState smartContractState, UInt256 totalSupply, string name, string symbol,
                                  byte decimals, string nativeChain, string nativeAddress) : base(smartContractState)
    {
